...
const FEATURES = [
  {
    ...
    d: "自然语言提问，自动多步调研生成研报",
    href: "/assistant",
    tone: "from-primary to-cyan",
  },
  {
    icon: IconChart,
    t: "全市场行情",
    d: "A股/港股/美股/加密 实时报价与榜单",
    href: "/market",
...
const PAINS = [
  {
    n: "01",
    t: "信息过载",
    d: "资讯碎片化、噪音多，难以快速提取关键信号",
    s: "AI 资讯聚合 + 情绪/事件解读",
  },
  {
    n: "02",
    t: "研究门槛高",
    d: "财务、技术指标专业且分散，新手难入门",
    s: "一句话调研，自动汇总多维数据",
  },
  {
    n: "03",
      ...
      <section className="grid items-center gap-8 pt-2 lg:grid-cols-[0.92fr_1.08fr]">
        <div className="animate-rise">
          <div className="chip mb-5">
            <span
              className="h-2 w-2 rounded-full bg-down"
              style={{ animation: "fs-pulse 2s infinite" }}
            />
            全市场覆盖 · A股 / 港股 / 美股 / 加密
          </div>
          ...
          <p className="mt-5 max-w-xl text-base leading-relaxed text-muted">
            FinSight 以 AI
            研究助手为核心，串联实时行情、资讯、财务、技术分析、策略回测与信号提醒，
            把碎片化信息变成系统化的研究决策。
          </p>
            ...
            return (
              ...
              >
                <GlassCard className="group h-full p-5">
                  <span
                    className={`grid h-11 w-11 place-items-center rounded-xl bg-gradient-to-br ${f.tone} text-white shadow-[0_8px_22px_-10px_var(--glow-primary)]`}
                  >
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {PAINS.map((p, i) => (
            <GlassCard
              ...
              style={{ animationDelay: `${i * 60}ms` }}
            >
              <div className="font-display text-3xl font-bold text-line-strong">
                {p.n}
              </div>
        ...
        >
          <div
            ...
            style={{
              ...
              maskImage:
                "radial-gradient(circle at 50% 50%, #000, transparent 75%)",
              WebkitMaskImage:
                "radial-gradient(circle at 50% 50%, #000, transparent 75%)",
            }}
          />
          <div className="relative">
            <h2 className="font-display text-2xl font-bold text-ink sm:text-3xl">
              把每一次投资决策，建立在
              <span className="text-gradient">专业数据 + AI 洞察</span>之上
            </h2>
            <p className="mx-auto mt-3 max-w-xl text-sm text-muted">
              所有行情、财务与资讯均来自公开真实接口，AI
              仅做分析与整理，绝不编造数据。
            </p>
